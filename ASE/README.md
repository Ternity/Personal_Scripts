...
- In file `potential.py`, one can use it to calculate electrostatic potential alone the specified axis by integrating the lattice charge density in the `LOCPOT` file.
